...
namespace AccountManager.Application.Accounts.Commands.CreateAccount
{
    public class CreateAccountCommandValidator : AbstractValidator<CreateAccountCommand>
    {
        ...
        public CreateAccountCommandValidator(ICloudStateDbContext context, ILibraryFileService libraryFileService)
        {
            _context = context;
        ...
        private async Task LibraryFileValid(
            ...
            ValidationContext<CreateAccountCommand> context,
        ...
        private async Task AccountNameUnique(CreateAccountCommand command,
            ValidationContext<CreateAccountCommand> context,
            CancellationToken cancellationToken)
        {
