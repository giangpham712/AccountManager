...
{
    public class CreateDraftAccountCommandHandler : CommandHandlerBase<CreateDraftAccountCommand, Guid>
    {
        ...
        public CreateDraftAccountCommandHandler(
            IMediator mediator, 
            ...
            IDraftAccountService draftAccountService) : base(mediator, context)
        {
        ...
        public override async Task<Guid> Handle(CreateDraftAccountCommand command, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                var machine = new Machine
                {
                    ...
                    LauncherUrl =
                        $"{(command.EnableSsl ? "https" : "http")}://{account.UrlFriendlyName}.planetassociates.net",
            ...
            return _draftAccountService.CreateDraftAccount(account);
        }
    }
}