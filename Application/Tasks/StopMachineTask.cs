...
{
    public class StopMachineTask : MachineTaskBase<MachineTaskArgsBase>
    {
        public StopMachineTask(MachineTaskArgsBase taskArgs) : base(taskArgs)
        {
        }

        public override TaskType Type => TaskType.StopMachine;
